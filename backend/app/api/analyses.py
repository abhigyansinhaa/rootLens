...
def _analysis_to_out(a: Analysis) -> dict[str, Any]:
    base: dict[str, Any] = {
        ...
        "schema_hash": getattr(a, "schema_hash", None),
        "dataset_hash": getattr(a, "dataset_hash", None),
        "failed_reason": getattr(a, "failed_reason", None),
    }
    if a.shap_json:
...
def create_analysis(
    ...
    if settings.redis_url:
        try:
            from app.infrastructure.queue import enqueue_analysis
